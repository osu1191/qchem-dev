...
void PEQSclass::Allocate()
{
  ...
  eps = QAllocDouble(NTotPts);
  ifunc = QAllocDouble(NTotPts);
  ...
  delRhoElec = QAllocDouble(3*NTotPts);
  delCart = QAllocDouble(3*NTotPts);
  ...
  phi_sccs = QAllocDouble(NTotPts); // Solvent aware
  t_eta = QAllocDouble(NTotPts); // Solvent aware
  mod_sr = QAllocDouble(NTotPts); // Solvent aware
  tst_sr = QAllocDouble(NTotPts); // Solvent aware
  FillFrac = QAllocDouble(NTotPts); // Solvent aware
  npro = QAllocDouble(NTotPts); // Solvent aware
  conv = QAllocDouble(NTotPts); // Solvent aware
  norm = QAllocDouble(NTotPts); // Solvent aware
